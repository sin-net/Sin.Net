...
namespace Sin.Net.Domain.System.Extensions
{
    ...
    public static class ObjectCloneExtensions
    {
        ...
        /// </summary>
        /// <param name="type">die aufrufende Instanz</param>
        /// <returns>Gibt 'true' zurück, wenn der Typ primitiv ist, andernfalls 'false'.</returns>
        ...
        /// </summary>
        /// <param name="originalObject">das Original-Objekt</param>
        /// <returns>die unabhängige Kopie</returns>
